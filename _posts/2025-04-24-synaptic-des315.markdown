...
---
UE 5.4 Cross-discipline, narrative focused project
<!--more-->
...
## Breakdown
University group project simulating a studio environment to produce a playable demo with the brief "Fire Walk with Me" A lynchian genre.

Made in UE 5.4 my role was system programmer and was responsible for creating aspects of the game that governed:
- Target behaviour
- Wave formations (target activation)
- Level loading
- Audio narration
- Object Interactions
